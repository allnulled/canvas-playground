  ...
  if (canvas.getContext) {
    ...
    const Persona = class {
      ...
      pintarse(ctx) {
        ...
        let punto_de_la_pierna_izq = undefined;
        let punto_de_la_pierna_der = undefined;
        ...
        Proceso_pintar_antepierna_izq: {
          ...
          punto_de_la_pierna_izq = [antepierna_izq_destino_x, antepierna_izq_destino_y];
        ...
        Proceso_pintar_antepierna_der: {
          ...
          punto_de_la_pierna_der = [antepierna_der_destino_x, antepierna_der_destino_y];
        ...
        Proceso_pintar_pierna_izq: {
          const pierna_izq_origen_x = punto_de_la_pierna_izq[0];
          const pierna_izq_origen_y = punto_de_la_pierna_izq[1];
          const pierna_izq_destino_x = punto_de_la_pierna_izq[0];
          const pierna_izq_destino_y = punto_de_la_pierna_izq[1] + 60;
        ...
        Proceso_pintar_pierna_der: {
          const pierna_der_origen_x = punto_de_la_pierna_der[0];
          const pierna_der_origen_y = punto_de_la_pierna_der[1];
          const pierna_der_destino_x = punto_de_la_pierna_der[0];
          const pierna_der_destino_y = punto_de_la_pierna_der[1] + 60;
